...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <div class="d-flex justify-content-between mb-3">
            <h3>All Products</h3>
            <form class="d-flex" action="products_show.php" method="post">
        ...
        <table class="table table-hover table-bordered text-center table-primary">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <th scope="row"><?= $i++ ?></th>
                        <td><a title="Show Details of product" href="product_details_ui.php?product_id=<?= $all_products['id'] ?>" style="text-decoration: none; font-weight: bold;"><?= $all_products['name'] ?></a></td>
                        <?php
