...
<main class="container-fluid">
    <div class="bg-light p-5 rounded">
        ...
        <?php } ?>
        <form action="product_edit.php" enctype="multipart/form-data" method="post">
            ...
            <div class="row mb-2">
                <div class="col-6">
                    ...
                    <input required type="text" name="name" class="form-control" id="formControlInput" value="<?= $name ?>">
                </div>
                <div class="col-6">
                    <?php
                    $connect = db_connect();
                    ...
                    <select required name="category_id" class="form-select" aria-label="Default select">
                        ...
                        <?php while ($all_category = mysqli_fetch_assoc($result2)) { ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-6">
                    ...
                    <input required type="number" name="unit_price" class="form-control" id="formControlInput" value="<?= $unit_price ?>">
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-6">
